...
# c.JupyterHub.data_files_path = '/share/jupyter/hub'
...
c.JupyterHub.pid_file = '/var/www/pipelines/jupyter.pid'
...
#
# Use with ssl_key
c.JupyterHub.ssl_cert = '/etc/letsencrypt/live/pipelines.kjamistan.com/fullchain.pem'

# Path to SSL key file for the public facing interface of the proxy
#
# Use with ssl_cert
c.JupyterHub.ssl_key = '/etc/letsencrypt/live/pipelines.kjamistan.com/privkey.pem'
...
c.Spawner.cmd = ['/home/deploy/venv/bin/jupyterhub-singleuser']
...
c.Spawner.env_keep = ['PATH', 'PYTHONPATH', 'CONDA_ROOT',
                      'CONDA_DEFAULT_ENV', 'DEPLOY', 'VIRTUAL_ENV',
                      'LANG', 'LC_ALL', ]
...
#c.Spawner.environment = {'VIRTUAL_ENV': '/home/deploy/venv',
 #                        'PYTHONPATH': '/home/deploy/venv/bin/python'}
...
c.Authenticator.admin_users = set(['deploy'])
